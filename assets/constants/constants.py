...
COMMODITY_TYPES = ["CTP", "BIGBAG", "TUBE", 
                   "BEAMS", "FIL M", "COIL","FORMWORK",]

GOODS__TYPES={"PLYWOOD", "BIG" ,"BAG", "TUBE","BEAMS", "FIL M","FIL", "COIL","BOB","CTP","FORMWORK"}
...
KEYWORD_RULES = [
    ...
    (["QUARTZ SAND", "ANTHRACITE COAL","Anthracite","Coal", "CALCINED"], "BIG BAG"),
