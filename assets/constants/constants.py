...
COMMODITY_TYPES = [ "TUBE", "POUTRELLE", "CORNIERE", "BOBINE", "CTP", "MDF", "FFP",
 "MDF + PLYWOOD", "BUS", "MINI BUS", "CAMIONS", "CAMION POMPE A BETON", "REMORQUES",
...
KEYWORD_RULES = [
    ...
    (["BRIDGE", "GIRDER ERECTION", 
      "COMPONENTS FOR BRIDGE", "BRIDGE COMP"], "BRIDGE COMPOSANT"),
