...
COMMODITY_TYPES = ["COLIS", "TUBE", "POUTRELLE", "CORNIERE", "BOBINE", "CTP", "MDF", "FFP", "MDF + PLYWOOD", "BUS", "MINI BUS", "CAMIONS", "CAMION POMPE A BETON", "REMORQUES", "EXCAVATEUR", "BULLDOZER", "CHARGEUR", "COMPACTEUR", "FINISSEUR", "CAMION GRUE", "CHARIOT ELEVATEUR", "NIVELEUSE"]
